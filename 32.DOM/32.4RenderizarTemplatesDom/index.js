...
//PRODUCTS 3
const products3Sel = document.querySelector("#products3");//ID

let templates = " "; //let para que te permita modificar
objetos.forEach((cadaElemento) => {
    cadaElemento = `<h3 style="background-color:purple; color:white; padding: 10px; margin: 10px"> ${cadaElemento.nombre} - PRECIO : ${cadaElemento.precio}</h3>`
    templates = templates + cadaElemento;
})

products3Sel.innerHTML = templates; //IMPRESION DE LOS OBJETOS CON INNER DE TEMPLATES