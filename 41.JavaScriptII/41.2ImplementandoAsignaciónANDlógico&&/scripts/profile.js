...
💧2.Define una variable isOnline y asigna un valor inicial de false. Esto representará si el usuario está conectado o no inicialmente.
💧3.Utiliza la función prompt() para preguntar al usuario si está conectado. La pregunta debe ser clara y especificar que las respuestas posibles 
son "SI" o "NO".
💧4.Implementa una condición que verifique la respuesta del usuario. Convierte la respuesta a mayúsculas para evitar problemas de mayúsculas y 
minúsculas. Si la respuesta es "SI" y (&&) isOnline es false, cambia el valor de isOnline a true.
💧5.Dependiendo del estado de isOnline, muestra un mensaje diferente en la consola. Si isOnline es true, muestra un mensaje indicando que el 
usuario está conectado y se mostrará el "template". Si es false, indica que el usuario no está conectado y el "template" será ocultado.
Completa los pasos anteriores y ejecuta tu script en el navegador. Observa cómo cambian los mensajes en la consola según las diferentes respuestas 
que ingreses en el prompt.
*/
